    ...
    <div style={{ 
      ...
      >
        ...
        <div className="event-grid" style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              margin: '0',
              fontFamily: "'Cormorant Garamond', Georgia, serif",
            }}>21<sup>st</sup> January<br /><span style={{ fontSize: '16px', fontWeight: '400' }}>Wednesday</span></p>
            <p style={{
              fontSize: '14px',
              color: '#4c1d95',
              margin: '2px 0 0 0',
          ...
          <div style={{
            ...
            <p style={{
              ...
              fontFamily: "'Outfit', sans-serif",
              fontWeight: '500',
            }}>Dept of Design and Manufacturing</p>
          </div>
        </div>

        {/* Online Video Link and Map Link */}
        <div className="link-buttons" style={{
          ...
          <a 
            href="https://meet.google.com/efs-gfvk-kjt" 
            target="_blank" 
            rel="noopener noreferrer"
            style={{
              display: 'flex',
              ...
              borderRadius: '25px',
              textDecoration: 'none',
              boxShadow: '0 3px 12px rgba(66,133,244,0.3)',
            }}
          >
          ...
          <a 
            href="https://maps.app.goo.gl/f7jTFV4PK4XT7MT17" 
            target="_blank" 
            rel="noopener noreferrer"
            style={{
              display: 'flex',
